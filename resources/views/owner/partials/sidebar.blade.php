<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('owner.data_users') }}">
            <i class="fas fa-fw fa-cog"></i>
            <span>Users</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('owner.data_product') }}">
            <i class="fas fa-fw fa-wrench"></i>
            <span>Product</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('owner.transaksi.riwayat') }}" >
            <i class="fas fa-file-invoice"></i>
            <span>History</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('owner.log_activity') }}">
